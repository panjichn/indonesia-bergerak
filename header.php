				...
				<div class="container">
					<div class="row">
						<div id="logo" class="col-xs-4 col-sm-3 col-md-3 hidden-sm hidden-xs">
							<a href="index.php"><img src="img/logo1.png" alt="logo" style="max-width: 150px;"></a>
						</div> <!-- //logo -->
					...
					<div class="row">
						<div class="visible-sm visible-xs col-sm-12">
							<div class="mobile-logo pull-left">
								<a href="index.php"><img src="img/logo1.png" alt="logo" style="max-width: 130px;"></a>
							</div>
					...
					<div class="row">
						<div class="col-sm-12">
							<ul class="list-inline megamenu-parent">
													...
													<div class="row">
														<div class="col-sm-3">
															<ul class="tab-btns" role="tablist">
																<li class="active"><a href="#pusat1" data-toggle="tab">Pemerintah Pusat 1</a></li>
																<li><a href="#pusat2" data-toggle="tab">Pemerintah Pusat 2</a></li>
																<li><a href="#pusat3" data-toggle="tab">Pemerintah Pusat 3</a></li>
																<li><a href="#pusat4" data-toggle="tab">Pemerintah Pusat 4</a></li>
														...
														<div class="col-sm-9">
															<div class="tab-content simple-article-overlay">
																<div role="tabpanel" class="tab-pane active" id="pusat1">
																	<div class="row">
																		<div class="col-sm-4">
																			<article class="item">
                                ...
                                <li class="has-child menu-justify">
									<a href="article-categories.html">Pemerintah Daerah</a>
									<div class="dropdown-inner container dropdown-menu-full-wrapper">
										<div class="dropdown-menu-full vertical-tabs">
											<div class="row">
												<div class="col-sm-12">
													<div class="row">
														<div class="col-sm-3">
															<ul class="tab-btns" role="tablist">
																<li class="active"><a href="#dki" data-toggle="tab">DKI Jakarta</a></li>
																<li><a href="#jabar" data-toggle="tab">Jawa Barat</a></li>
																<li><a href="#aceh" data-toggle="tab">Aceh</a></li>
																<li><a href="#jateng" data-toggle="tab">Jawa Tengah</a></li>
														...
														<div class="col-sm-9">
															<div class="tab-content simple-article-overlay">
																<div role="tabpanel" class="tab-pane active" id="dki">
																	<div class="row">
																		<div class="col-sm-4">
																			<article class="item">
																				<div class="article-inner">
																		...
																		<div class="col-sm-4">
																			<article class="item">
																				<div class="article-inner">
																					<div class="overlay"></div>
																					<div class="img-wrapper"><img class="img-100p latest-post-image" src="img/pemda/dki2.jpg" alt="img"></div>
																					<div class="post-share-social">
																						<a href="#" class="fa fa-facebook"></a>
																						<a href="#" class="fa fa-twitter"></a>
																						<a href="#" class="fa fa-google-plus"></a>
																		...
																		<div class="col-sm-4">
																			<article class="item">
																				<div class="article-inner">
																					<div class="overlay"></div>
																					<div class="img-wrapper"><img class="img-100p latest-post-image" src="img/pemda/dki3.jpg" alt="img"></div>
																					<div class="post-share-social">
																						<a href="#" class="fa fa-facebook"></a>
																						<a href="#" class="fa fa-twitter"></a>
																						<a href="#" class="fa fa-google-plus"></a>
																	...
																	<div class="row">
																		<div class="col-sm-4">
																			<article class="item">
																				<div class="article-inner">
																					<div class="overlay"></div>
																					<div class="img-wrapper"><img class="img-100p latest-post-image" src="img/pemda/jabar1.jpg" alt="img"></div>
																					<div class="post-share-social">
																						<a href="#" class="fa fa-facebook"></a>
																						<a href="#" class="fa fa-twitter"></a>
																						<a href="#" class="fa fa-google-plus"></a>
																		...
																		<div class="col-sm-4">
																			<article class="item">
																				<div class="article-inner">
																					<div class="overlay"></div>
																					<div class="img-wrapper"><img class="img-100p latest-post-image" src="img/pemda/jabar2.jpg" alt="img"></div>
																					<div class="post-share-social">
																						<a href="#" class="fa fa-facebook"></a>
																						<a href="#" class="fa fa-twitter"></a>
																						<a href="#" class="fa fa-google-plus"></a>
																		...
																		<div class="col-sm-4">
																			<article class="item">
																				<div class="article-inner">
																					<div class="overlay"></div>
																					<div class="img-wrapper"><img class="img-100p latest-post-image" src="img/pemda/jabar3.jpg" alt="img"></div>
																					<div class="post-share-social">
																						<a href="#" class="fa fa-facebook"></a>
																						<a href="#" class="fa fa-twitter"></a>
																						<a href="#" class="fa fa-google-plus"></a>
								...
								<li class="has-child menu-justify">
									<a href="article-categories.html">BUMN</a>
									<div class="dropdown-inner container dropdown-menu-full-wrapper">
										<div class="dropdown-menu-full vertical-tabs">
											<div class="row">
												<div class="col-sm-12">
													<div class="row">
														<div class="col-sm-3">
															<ul class="tab-btns" role="tablist">
																<li class="active"><a href="#pertamina" id="link-pertamina" data-toggle="tab" >Pertamina</a></li>
																<li><a href="#pln" id="link-pln" data-toggle="tab">PLN</a></li>
																<li><a href="#telkom" data-toggle="tab">Telkom</a></li>
																<li><a href="#antam" data-toggle="tab">Antam</a></li>
														...
														<div class="col-sm-9">
															<div class="tab-content simple-article-overlay">
																<div role="tabpanel" class="tab-pane active" id="pertamina">
																	<div class="row">
																		<div class="col-sm-4">
																			<article class="item">
																				<div class="article-inner">
